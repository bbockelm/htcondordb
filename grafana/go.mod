...
require (
	github.com/PelicanPlatform/classad v0.24.1
	github.com/PelicanPlatform/classad/dbrpc v0.24.1
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.24.1 // indirect
	github.com/PelicanPlatform/classad/db v0.24.1 // indirect
