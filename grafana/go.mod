...
require (
	github.com/PelicanPlatform/classad v0.23.1
	github.com/PelicanPlatform/classad/dbrpc v0.23.1
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.23.1 // indirect
	github.com/PelicanPlatform/classad/db v0.23.1 // indirect
