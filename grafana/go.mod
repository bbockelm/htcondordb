...
require (
	github.com/PelicanPlatform/classad v0.28.0
	github.com/PelicanPlatform/classad/dbrpc v0.28.0
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.28.0 // indirect
	github.com/PelicanPlatform/classad/db v0.28.0 // indirect
