...
require (
	github.com/PelicanPlatform/classad v0.27.0
	github.com/PelicanPlatform/classad/dbrpc v0.27.0
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.27.0 // indirect
	github.com/PelicanPlatform/classad/db v0.27.0 // indirect
