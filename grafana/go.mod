...
require (
	github.com/PelicanPlatform/classad v0.25.1
	github.com/PelicanPlatform/classad/dbrpc v0.25.1
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.25.1 // indirect
	github.com/PelicanPlatform/classad/db v0.25.1 // indirect
