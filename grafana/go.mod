...
require (
	github.com/PelicanPlatform/classad v0.29.3
	github.com/PelicanPlatform/classad/dbrpc v0.29.3
...
require (
	...
	github.com/PelicanPlatform/classad/collections v0.29.3 // indirect
	github.com/PelicanPlatform/classad/db v0.29.3 // indirect
