...
require (
	...
	github.com/PelicanPlatform/classad/changefeed v0.25.2
	github.com/PelicanPlatform/classad/collections v0.25.2
	github.com/PelicanPlatform/classad/db v0.25.2
