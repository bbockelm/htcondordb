...
require (
	...
	github.com/PelicanPlatform/classad/changefeed v0.29.7
	github.com/PelicanPlatform/classad/collections v0.29.7
	github.com/PelicanPlatform/classad/db v0.29.7
